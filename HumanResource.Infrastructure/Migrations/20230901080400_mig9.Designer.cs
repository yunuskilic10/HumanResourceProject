            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "90548e4f-9978-4873-a108-f167509ba006",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "2b8e1701-68f2-47e9-854d-030421350f7e",
                            Name = "CompanyManager",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "40cba75c-ad49-409e-878c-ceba5d603a84",
                            Name = "Personnel",
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 329, DateTimeKind.Local).AddTicks(9170),
                            Name = "BilgeAdam Akademi"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 329, DateTimeKind.Local).AddTicks(9172),
                            Name = "Neos Akademi"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 329, DateTimeKind.Local).AddTicks(9174),
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1524),
                        ...
                        new
                        {
                            Id = 2,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1529),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 3,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1530),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 4,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1532),
                        ...
                        new
                        {
                            Id = 5,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1534),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 6,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1536),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 7,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1537),
                        ...
                        new
                        {
                            Id = 8,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1539),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        },
                        new
                        {
                            Id = 9,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(1541),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        });
                });
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(3715),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(3717),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(3719),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(3721),
                            DepartmentId = 7,
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(3723),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 6,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(3725),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 7,
                            CreateDate = new DateTime(2023, 9, 1, 11, 4, 0, 330, DateTimeKind.Local).AddTicks(3726),
                            DepartmentId = 4,
