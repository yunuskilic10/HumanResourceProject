...
namespace HumanResource.Infrastructure.Migrations
{
    ...
    [Migration("20230905074016_mig11")]
    partial class mig11
    {
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "d9e0a7d2-8e14-444e-b434-24e51c5a234c",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "e575c592-9a9a-4b61-88f9-2a35365f952b",
                            Name = "CompanyManager",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "48811f15-8331-40b6-8126-259069188520",
                            Name = "Personnel",
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 177, DateTimeKind.Local).AddTicks(8849),
                            Name = "BilgeAdam Akademi"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 177, DateTimeKind.Local).AddTicks(8851),
                            Name = "Neos Akademi"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 177, DateTimeKind.Local).AddTicks(8853),
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(941),
                        ...
                        new
                        {
                            Id = 2,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(943),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 3,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(945),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 4,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(947),
                        ...
                        new
                        {
                            Id = 5,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(949),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 6,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(950),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 7,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(952),
                        ...
                        new
                        {
                            Id = 8,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(954),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        },
                        new
                        {
                            Id = 9,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(955),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        });
                });
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(2987),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(2989),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(2991),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(2993),
                            DepartmentId = 7,
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(2994),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 6,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(2996),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 7,
                            CreateDate = new DateTime(2023, 9, 5, 10, 40, 16, 178, DateTimeKind.Local).AddTicks(2997),
                            DepartmentId = 4,
