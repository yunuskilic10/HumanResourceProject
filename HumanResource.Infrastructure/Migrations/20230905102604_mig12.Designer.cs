...
namespace HumanResource.Infrastructure.Migrations
{
    ...
    [Migration("20230905102604_mig12")]
    partial class mig12
    {
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "3b382b00-74d4-4069-ac02-b44c62855ef6",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "81f43ef6-dfbc-4fb2-9290-57636d689ce6",
                            Name = "CompanyManager",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "34da642d-978d-435d-b039-bd7a45e7352e",
                            Name = "Personnel",
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "Istanbul",
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 645, DateTimeKind.Local).AddTicks(7945),
                        ...
                        new
                        {
                            Id = 2,
                            Address = "Ankara",
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 645, DateTimeKind.Local).AddTicks(7949),
                            Name = "Neos Akademi"
                        },
                        new
                        {
                            Id = 3,
                            Address = "Antalya",
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 645, DateTimeKind.Local).AddTicks(7951),
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(742),
                        ...
                        new
                        {
                            Id = 2,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(745),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 3,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(754),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 4,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(756),
                        ...
                        new
                        {
                            Id = 5,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(759),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 6,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(761),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 7,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(763),
                        ...
                        new
                        {
                            Id = 8,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(765),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        },
                        new
                        {
                            Id = 9,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(767),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        });
                });
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(4579),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(4582),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(4584),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(4587),
                            DepartmentId = 7,
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(4589),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 6,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(4591),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 7,
                            CreateDate = new DateTime(2023, 9, 5, 13, 26, 3, 646, DateTimeKind.Local).AddTicks(4593),
                            DepartmentId = 4,
