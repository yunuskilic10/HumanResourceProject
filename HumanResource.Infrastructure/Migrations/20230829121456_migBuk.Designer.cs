...
namespace HumanResource.Infrastructure.Migrations
{
    ...
    [Migration("20230829121456_migBuk")]
    partial class migBuk
    {
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "ad169c03-6373-4450-9f0f-271fe7788e38",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "e6e813a5-efbe-4664-8e56-6f2949652c8a",
                            Name = "CompanyManager",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "d8d6ca5a-a48f-4e50-87ba-f3afcec75921",
                            Name = "Personnel",
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 139, DateTimeKind.Local).AddTicks(6133),
                            Name = "BilgeAdam Akademi"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 139, DateTimeKind.Local).AddTicks(6138),
                            Name = "Neos Akademi"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 139, DateTimeKind.Local).AddTicks(6142),
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1515),
                        ...
                        new
                        {
                            Id = 2,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1524),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 3,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1533),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 4,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1537),
                        ...
                        new
                        {
                            Id = 5,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1540),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 6,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1544),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 7,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1556),
                        ...
                        new
                        {
                            Id = 8,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1560),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        },
                        new
                        {
                            Id = 9,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(1564),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        });
                });
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(8796),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(8803),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(8809),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(8815),
                            DepartmentId = 7,
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(8821),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 6,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(8827),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 7,
                            CreateDate = new DateTime(2023, 8, 29, 15, 14, 56, 140, DateTimeKind.Local).AddTicks(8833),
                            DepartmentId = 4,
