...
namespace HumanResource.Infrastructure.Migrations
{
    ...
    [Migration("20230822153900_bismillah")]
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "306f41d0-e60a-49d1-bb7e-56877e052dce",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "f33c3166-0e56-449d-ad47-3b8594404cd2",
                            Name = "CompanyManager",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "cdabbcec-87cb-417f-898a-3205e7797346",
                            Name = "Personnel",
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(2739),
                            Name = "BilgeAdam Akademi"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(2743),
                            Name = "Neos Akademi"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(2744),
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5325),
                        ...
                        new
                        {
                            Id = 2,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5328),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 3,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5330),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 4,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5333),
                        ...
                        new
                        {
                            Id = 5,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5335),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 6,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5337),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 7,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5340),
                        ...
                        new
                        {
                            Id = 8,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5342),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        },
                        new
                        {
                            Id = 9,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(5344),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        });
                });
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(7735),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(7739),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(7741),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(7744),
                            DepartmentId = 7,
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(7746),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 6,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(7748),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 7,
                            CreateDate = new DateTime(2023, 8, 22, 18, 38, 59, 929, DateTimeKind.Local).AddTicks(7757),
                            DepartmentId = 4,
