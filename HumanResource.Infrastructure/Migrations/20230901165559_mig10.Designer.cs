...
namespace HumanResource.Infrastructure.Migrations
{
    ...
    [Migration("20230901165559_mig10")]
    partial class mig10
    {
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "fe6db621-78b9-4fd5-9238-08f7e54230de",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "be2cd2ed-9836-432e-83cf-3b319fac4cdf",
                            Name = "CompanyManager",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "040bdfb9-8fd9-4153-9193-a42780166056",
                            Name = "Personnel",
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 900, DateTimeKind.Local).AddTicks(7937),
                            Name = "BilgeAdam Akademi"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 900, DateTimeKind.Local).AddTicks(7944),
                            Name = "Neos Akademi"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 900, DateTimeKind.Local).AddTicks(7950),
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5676),
                        ...
                        new
                        {
                            Id = 2,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5685),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 3,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5692),
                            Description = "Generate secure random user identities with hashed passwords and salts using this code snippet.",
                            Name = "IT"
                        },
                        new
                        {
                            Id = 4,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5699),
                        ...
                        new
                        {
                            Id = 5,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5705),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 6,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5712),
                            Description = "Human Resources (HR) is a critical function that oversees personnel activities, including recruitment, training, benefits, and workplace policies.",
                            Name = "Human Resources"
                        },
                        new
                        {
                            Id = 7,
                            CompanyId = 1,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5718),
                        ...
                        new
                        {
                            Id = 8,
                            CompanyId = 2,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5724),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        },
                        new
                        {
                            Id = 9,
                            CompanyId = 3,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 901, DateTimeKind.Local).AddTicks(5731),
                            Description = "The Services Department ensures efficient business operations by offering essential support functions such as customer assistance, technical help, maintenance, and issue resolution.",
                            Name = "Services Departmants"
                        });
                });
            ...
            modelBuilder.Entity("HumanResource.Domain.Entities.Concrete.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 902, DateTimeKind.Local).AddTicks(3116),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 902, DateTimeKind.Local).AddTicks(3123),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 902, DateTimeKind.Local).AddTicks(3129),
                            DepartmentId = 1,
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 902, DateTimeKind.Local).AddTicks(3135),
                            DepartmentId = 7,
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 902, DateTimeKind.Local).AddTicks(3141),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 6,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 902, DateTimeKind.Local).AddTicks(3147),
                            DepartmentId = 4,
                        ...
                        {
                            Id = 7,
                            CreateDate = new DateTime(2023, 9, 1, 19, 55, 58, 902, DateTimeKind.Local).AddTicks(3153),
                            DepartmentId = 4,
